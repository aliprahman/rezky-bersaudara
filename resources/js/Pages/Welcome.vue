    ...
    >
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <div class="flex justify-center mt-16 px-6 sm:items-center sm:justify-between">
                <div class="text-center text-lg text-gray-500 dark:text-gray-400 sm:text-left">
                ...
                <div class="ml-4 text-center text-lg text-gray-500 dark:text-gray-400 sm:text-right sm:ml-0">
